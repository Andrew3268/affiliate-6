class HotdealsController < ApplicationController
  ...
  def index
    @hotdeals = Hotdeal.all.order("created_at DESC").page(params[:page]).per_page(50)
  ...
  private
    ...
    def hotdeal_params
      params.require(:hotdeal).permit(:h_title, :h_description, :h_image, :h_link, :h_price, :h_list_price, :h_percentage, :himage,
                                   ...
                                   :h_spare_24, :h_spare_25, :h_spare_26, :h_spare_27, :h_spare_28, :h_spare_29, :h_spare_30, :h_spare_31,
                                   :h_spare_32, :h_spare_33, :h_spare_34, :h_spare_35, :h_spare_41, :h_spare_42, :h_spare_43, :h_spare_44, 
                                   :h_spare_45, :h_spare_51, :h_spare_52, :h_spare_53, :h_spare_54, :h_spare_55)
    end
end
